<template>  
  ...
  <div>
    ...
    <report-deposit-view
      :is-report-deposit-view-active.sync="isAddNewUserSidebarActive" 
...
import ReportDepositView from './ReportDepositView.vue';
import ToastificationContent from '@core/components/toastification/ToastificationContent.vue'
import { useUtils as useI18nUtils } from '@core/libs/i18n'

export default {
  components: {
    // 'report-deposit-view':ReportDepositView,
    ReportDepositView,
    BRow,
    BCol,    
    VueGoodTable,
  ...
  methods: {
   ...
   async search(){
      ...
      const response = await this.GetReportDeposit(formData);
