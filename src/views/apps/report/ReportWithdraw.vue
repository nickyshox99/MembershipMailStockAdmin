<template>  
  ...
  <div>
    ...
    <report-withdraw-view
      :is-report-withdraw-view-active.sync="isAddNewUserSidebarActive" 
    ...
    <b-card :title="t('Withdraw Report')">
      <!-- table -->
      <vue-good-table
        :columns="columns"
        :rows="rows"
...
import ReportWithdrawView from './ReportWithdrawView.vue';
import ToastificationContent from '@core/components/toastification/ToastificationContent.vue'
import { useUtils as useI18nUtils } from '@core/libs/i18n'

export default {
  components: {
    // 'report-withdraw-view':ReportWithdrawView,
    ReportWithdrawView,
    BRow,
    BCol,    
    VueGoodTable,
  ...
  methods: {
   ...
   async search(){
      ...
      const response = await this.GetReportWithdraw(formData);
