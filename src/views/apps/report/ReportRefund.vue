<template>  
  ...
  <div>
    ...
    <report-refund-view
      :is-report-refund-view-active.sync="isAddNewUserSidebarActive" 
    ...
    <b-card :title="t('รายงานการคืนยอดเสีย')">
      <!-- table -->
      <vue-good-table
        :columns="columns"
        :rows="rows"
...
import ReportRefundView from './ReportRefundView.vue';
import ToastificationContent from '@core/components/toastification/ToastificationContent.vue'
import { useUtils as useI18nUtils } from '@core/libs/i18n'

export default {
  components: {
    // 'report-refund-view':ReportRrefundView,
    ReportRefundView,
    BRow,
    BCol,    
    VueGoodTable,
  ...
  methods: {
   ...
   async search(){
      ...
      const response = await this.GetReportRefund(formData);
