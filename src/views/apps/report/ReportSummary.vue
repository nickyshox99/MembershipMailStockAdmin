<template>  
  ...
  <div>
    ...
    <report-summary-view
      :is-report-summary-view-active.sync="isAddNewUserSidebarActive" 
...
export default {
  components: {
    // 'report-Summary-view':ReportSummaryView,
    ReportSummaryView,
    BRow,
    BCol,    
    VueGoodTable,
  ...
  methods: {
   ...mapActions(["GetAgent"]),
   ...mapActions(["GetReportSummaryMember"]),
   async search(){
      console.log('search');
      ...
      const response = await this.GetReportSummaryMember(formData);
