<template>
    ...
    <b-sidebar 
      id="report-bank-transaction-view" 
      ...
      right
      @hidden="resetForm"
      @change="(val) => $emit('update:is-report-bank-transaction-view-active', val)"
    >
  ...
  export default {
    ...
    model: {
      ...
      event: 'update:is-report-bank-transaction-view-active',
    },    
    props: {
    ...
    setup(props, { emit }) {
      ...
      const onSubmit = () => {
        store.dispatch('app-user/addUser', tmpData)
          .then(() => {
            emit('refetch-data')
            emit('update:is-report-bank-transaction-view-active', false)
          })
      }
