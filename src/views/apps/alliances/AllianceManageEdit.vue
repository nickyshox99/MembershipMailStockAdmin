...
<Transition name="bounce">
    <b-card-code v-if="isEditFormActive" id="alliance-manage-edit" :title="titleCard" 
    @hidden="resetForm" @change="(val) => $emit('update:is-alliance-manage-edit-active', val)">
        ...
        <b-tabs pills>
            ...
            <b-tab active>
                <template #title>
                    ...
                    <span class="d-none d-sm-inline">Alliance</span>
                </template>
                <div>
                    <b-media class="mb-2">
                        <template #aside>
                    ...
                    <b-button v-ripple.400="'rgba(255, 255, 255, 0.15)'" type="submit" variant="primary" class="mr-1" v-if="isModeEdit" @click="updateMember">
...
export default {
    ...
    model: {
        event: 'update:is-alliance-manage-edit-active',
        bankSelected: "1",
        bankOptions: [{
            value: null,
            text: 'Select Bank'
    ...
    methods: {
        ...
        async updateMember() {
            ...
            var body = {};
            body.id = this.pRowData.id?this.pRowData.id:'0';
            ...
            let response;
            await axios.post("api/alliance/updatealliancebyid", body, {
                headers: {
                    'Content-Type': 'application/json',
                    'userid': headers.userid,
                    'token': headers.token,
        ...
        async changePassword() {
            ...
            let response;
            await axios.post("api/alliance/changePasswordMemberByID", body, {
                headers: {
                    'Content-Type': 'application/json',
                    'userid': headers.userid,
                    'token': headers.token,
