...
<Transition name="bounce">
    <b-card-code v-if="isWithdrawFormActive" id="withdraw-manage-form" :title="titleCard" @hidden="resetForm" @change="(val) => $emit('update:is-withdraw-manage-form-active', val)">
...
export default {
    ...
    model: {
        event: 'update:is-withdraw-manage-form-active',
        bankSelected: "1",
        bankOptions: [{
            value: null,
            text: 'Select Bank'
        }, ],
        titleCard: "Withdraw Credit",
        sumdeposit:0,
        sumwithdraw:0,
        sumprofit:0,
    },
    props: {
        isWithdrawFormActive: {
            type: Boolean,
            required: true,
        },      
        pRowData: {
