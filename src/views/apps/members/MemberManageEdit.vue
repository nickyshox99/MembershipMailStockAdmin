                ...
                <b-tabs v-model="tabIndex" pills @input="tabChange">
                                ...
                                <b-row>
                                    ...
                                    <b-col md="6">
                                        <b-form-group :label="t('Line id')" label-for="lineid">
                                            <b-form-input id="lineid" v-model="pRowData.lineid"  />
                                        </b-form-group>
                                    </b-col>
                                </b-row>  
                    ...
                    <b-tab>
                        <template #title>
                            ...
                            <span class="d-none d-sm-inline">{{t('Create Loan')}}</span>
                        </template>
                        <div>
                            <b-media class="mb-2">
                                <template #aside>
                            ...
                            <b-form>
                                ...
                                <b-row>
                                    <b-col md="12">
                                        <b-form-checkbox
                                            id="showFile1"
                                            :checked="showCollateralImg1"
                                            v-model="showCollateralImg1"
                                            name="check-button-showfile1"
                                            switch
                                            inline
                                        >
                                ...
                                <b-row v-if="showCollateralImg1">
                                    <b-col md="6">
                                        <b-form-group              
                                            :label="t('Image for decision')"
                                            label-for="collateral-img1"
                                            >
                                            <b-img :src="collateral_img1" fluid thumbnail style="height: 200px;" v-if="collateral_img1.length>0" /><br/>
                                            <input type="file" @change="uploadFile2('collateral_img1')" ref="collateral_img1" v-if="collateral_img1.length<=0">
                                            <b-button v-ripple.400="'rgba(255, 255, 255, 0.15)'" variant="info" class="mt-1 mr-1"  @click="submitFile2('collateral_img1')" v-if="collateral_img1.length<=0">
                                                Upload
                                            </b-button>
                                            <b-badge style="cursor: pointer; margin-right:2px" variant="warning" v-if="collateral_img1.length>0" @click="deleteFile('collateral_img1')" >
                                    ...
                                    <b-col md="6">
                                        <b-form-group              
                                            :label="t('Image for decision')"
                                            label-for="collateral-img2"
                                            >
                                            <b-img :src="collateral_img2" fluid thumbnail style="height: 200px;" v-if="collateral_img2.length>0" /><br/>
                                            <input type="file" @change="uploadFile2('collateral_img2')" ref="collateral_img2" v-if="collateral_img2.length<=0">
                                            <b-button v-ripple.400="'rgba(255, 255, 255, 0.15)'" variant="info" class="mt-1 mr-1"  @click="submitFile2('collateral_img2')" v-if="collateral_img2.length<=0">
                                                Upload
                                            </b-button>
                                            <b-badge style="cursor: pointer; margin-right:2px" variant="warning" v-if="collateral_img2.length>0" @click="deleteFile('collateral_img2')" >
                                                    <feather-icon icon="XSquareIcon" size="16" class="mr-0 mr-sm-50" />                                                    
                                            </b-badge>
                                        </b-form-group>
                                    </b-col>
                                ...
                                <b-row v-if="showCollateralImg1">
                                    <b-col md="6">                                        
                                            <b-img :src="collateral_img3" fluid thumbnail style="height: 200px;" v-if="collateral_img3.length>0" /><br/>
                                            <input type="file" @change="uploadFile2('collateral_img3')" ref="collateral_img3" v-if="collateral_img3.length<=0">
                                            <b-button v-ripple.400="'rgba(255, 255, 255, 0.15)'" variant="info" class="mt-1 mr-1"  @click="submitFile2('collateral_img3')" v-if="collateral_img3.length<=0">
                                                Upload
                                            </b-button>
                                            <b-badge style="cursor: pointer; margin-right:2px" variant="warning" v-if="collateral_img3.length>0" @click="deleteFile('collateral_img3')" >
                                                    <feather-icon icon="XSquareIcon" size="16" class="mr-0 mr-sm-50" />                                                    
                                            </b-badge>                                        
                                    </b-col>
                                    <b-col md="6">
                                        <b-img :src="collateral_img4" fluid thumbnail style="height: 200px;" v-if="collateral_img4.length>0" /><br/>
                                            <input type="file" @change="uploadFile2('collateral_img4')" ref="collateral_img4" v-if="collateral_img4.length<=0">
                                            <b-button v-ripple.400="'rgba(255, 255, 255, 0.15)'" variant="info" class="mt-1 mr-1"  @click="submitFile2('collateral_img4')" v-if="collateral_img4.length<=0">
                                                Upload
                                            </b-button>
                                            <b-badge style="cursor: pointer; margin-right:2px" variant="warning" v-if="collateral_img4.length>0" @click="deleteFile('collateral_img3')" >
                                                    <feather-icon icon="XSquareIcon" size="16" class="mr-0 mr-sm-50" />                                                    
                                            </b-badge>
                                    </b-col>
                                </b-row>
                                ...
                                <b-row>
                                    <b-col md="12">                                
                                        <b-form-group              
                                            ...
                                            >
                                            <b-form-select id="loan-type-selected" v-model="interestTypeSelected" :options="interestTypeOptions" @change="loanTypeChange()"></b-form-select>
                                        </b-form-group>
                                    </b-col>
                                </b-row>  
                                <b-row>
                                ...
                                <b-row>
                                    <b-col md="3">
                                        <b-form-group :label="t('Period Type')" label-for="period-name">
                                            <b-form-input id="period-name" v-model="period_name" readonly  />
                                        </b-form-group>
                                    </b-col>
                                    <b-col md="3">
                                        <b-form-group :label="t('Collateral')" label-for="Collateral">
                                            <b-form-input id="Collateral" v-model="collateral_name" readonly  />
                                        </b-form-group>
                                    </b-col>
                                    <b-col md="3">
                                        <b-form-group :label="t('Calculate Interest Every')" label-for="cal-interest-every">
                                            <b-form-input id="cal-interest-every" v-model="period_number" type="number" readonly  />
                                        </b-form-group>
                                    </b-col>
                                    <b-col md="3">
                                        <b-form-group :label="t('Days')+'/'+t('Months')+'/'+t('Year')" label-for="cal-unit">
                                            <b-form-input id="cal-unit" v-model="period_unit" readonly  />
                                        </b-form-group>
                                    </b-col>
                                </b-row>
                                <b-row>
                                ...
                                <b-row>
                                    <b-col md="2">
                                        <b-form-group :label="t('Need Loan Amount')" label-for="loan-amount">
                                            <b-form-input id="loan-amount" v-model="loan_amount" type="number" :disabled="calculated_interest" style="background-color:rgb(247, 255, 179);"   />
                                        </b-form-group>
                                    </b-col>
                                    <b-col md="2">
                                        <b-form-group :label="t('Interest')" label-for="interest">
                                            <b-form-input id="interest" v-model="interest" type="number" :disabled="calculated_interest" style="background-color:rgb(247, 255, 179);" />
                                        </b-form-group>
                                    </b-col>
                                    <b-col md="2">
                                        <b-form-group :label="t('Interest')+t('Per')" label-for="per">
                                            <b-form-select id="interest-per-selected" v-model="interestPerSelected" :options="interestPerOptions" style="background-color:rgb(247, 255, 179);" ></b-form-select>
                                        </b-form-group>
                                    </b-col>
                                    <b-col md="2">
                                        <b-form-group :label="t('Longtime')+' ('+period_unit+')'" label-for="loan_longtime_number">
                                            <b-form-input id="loan_longtime_number" v-model="loan_longtime_number" type="number" :disabled="calculated_interest" style="background-color:rgb(247, 255, 179);" />
                                        </b-form-group>
                                    </b-col>
                                    <b-col md="2">
                                        <b-form-group :label="t('Start Date')" label-for="loan_start_at">                                    
                                            <b-form-datepicker id="loan_start_at" v-model="loan_start_at" style="background-color:rgb(247, 255, 179);" :disabled="calculated_interest" :date-format-options="{ year: 'numeric', month: 'short', day: '2-digit', weekday: 'short' }" locale="th"></b-form-datepicker>
                                        </b-form-group>
                                    </b-col>
                                    ...
                                    <b-col md="2">
                                        <b-form-group :label="t('Effective Rate')" label-for="effective_rate">
                                            <b-form-checkbox
                                                id="effective_rate"
                                                name="effective_rate"
                                                v-model="effective_rate"
                                                value="1"
                                                unchecked-value="0"    
                                                :disabled="calculated_interest"                                    
                                            >
                                                {{t('Yes')}}          
                                            </b-form-checkbox>                        
                                        </b-form-group>
                                ...
                                <b-row>                                      
                                    <b-col md="12">
                                        <b-form-group :label="t('Calculate')" label-for="calculate" >
                                            <b-button v-ripple.400="'rgba(255, 255, 255, 0.15)'" variant="primary" class="mr-1" v-if="isModeEdit" @click="calculateLoanInterest" :disabled="calculated_interest||!pagePermission.canEdit" >
                                                <feather-icon icon="EditIcon" />
                                                {{t('Calculate')}}
                                            </b-button>
                                            &nbsp;
                                            <b-button v-ripple.400="'rgba(255, 255, 255, 0.15)'" variant="warning" class="mr-1" v-if="isModeEdit" @click="clearCalculate" :disabled="!calculated_interest">
                            ...
                            <Transition name="bounce">
                                <b-row  v-if="calculated_interest">
                                    <b-col md="12">
                                        <hr/>
                                            <vue-good-table ref="my-table-calculate-table" :columns="columns" :rows="rows" :rtl="direction" :line-numbers="true"
                                            :search-options="{
                                                enabled: false,                                        
                                            }" :select-options="{
                                                enabled: false,
                            ...
                            <b-button v-ripple.400="'rgba(255, 255, 255, 0.15)'" variant="primary" class="mr-1" v-if="isModeEdit" @click="requestApprove" :disabled="!calculated_interest">
                                <feather-icon icon="EditIcon" />
                                {{t('Request Approve')}}
                            </b-button>
                    ...
                    <b-tab>
                        <template #title>
                            ...
                            <span class="d-none d-sm-inline">{{t('Request Loan List')}}</span>
                        </template>
                        <div>
                            <b-media class="mb-2">
                                <template #aside>
                            ...
                            <Transition name="bounce">
                                <b-row  v-if="!view_detail_request_loan && !showInspectApprove"  >
                                    <b-col md="12">
                                        <hr/>
                                            <vue-good-table ref="my-table-calculate-table" :columns="columnsRequestLoan" :rows="requestLoan" :rtl="direction" :line-numbers="true"
                                            :search-options="{
                                                enabled: false,                                        
                                            }" :select-options="{
                                                enabled: false,
                                                ...
                                                <template slot="table-row" slot-scope="props">
                                                    ...
                                                    <span v-if="props.column.field === 'create_at2'">              
                                                        {{formatDateAssigned(props.row.create_at)}}
                                                    </span>
                                                    
                                                    <span v-if="props.column.field === 'loan_amoun2'">       
                                                        <b-badge
                                                            pill
                                                            variant="success"
                                                        >
                                                            {{(props.row.loan_amount).toLocaleString(undefined, { maximumFractionDigits: 2, minimumFractionDigits: 2 })}}
                                                        </b-badge>
                                                    </span>
                                                    
                                                    <span v-if="props.column.field === 'interest2'">                                                              
                                                            {{(props.row.interest).toLocaleString(undefined, { maximumFractionDigits: 2, minimumFractionDigits: 2 })}}
                                                    </span>

                                                    <span v-if="props.column.field === 'loan_longtime_number2'">                                                              
                                                            {{(props.row.loan_longtime_number)+" "+t(props.row.period_name) }}
                                                    </span>

                                                    <span v-if="props.column.field === 'period_number2'">                                                              
                                                            {{(props.row.period_number)+" "+t(props.row.period_name) }}
                                                    </span>
                                                    
                                                    <span v-if="props.column.field === 'loan_start_at2'">              
                                                        {{formatDateAssigned2(props.row.loan_start_at)}}
                                                    </span>

                                                    <span v-if="props.column.field === 'action'">    
                                                            
                                                        <div v-if="props.row.rejected==0">   
                                                            <b-badge style="cursor: pointer; margin-right:2px" variant="info" @click="inspectApprove(props.row)">
                                                                <feather-icon icon="SearchIcon" size="16" class="mr-0 mr-sm-50" />
                                                                <span class="d-none d-sm-inline">{{t('Inspect')}}</span>
                                                            </b-badge>

                                                            <b-badge style="cursor: pointer; margin-right:2px" variant="success" @click="confirmApprove(props.row.id)" :disabled="!pagePermission.CanApprove" >
                                                                <feather-icon icon="CheckSquareIcon" size="16" class="mr-0 mr-sm-50" />
                                                                <span class="d-none d-sm-inline">{{t('Approve')}}</span>
                                                            </b-badge>
                                                            
                                                            <b-badge style="cursor: pointer; margin-right:2px" variant="warning" @click="confirmReject(props.row.id)" :disabled="!pagePermission.CanApprove">
                                                                <feather-icon icon="XSquareIcon" size="16" class="mr-0 mr-sm-50" />
                            ...
                            <b-button @click="close" v-ripple.400="'rgba(186, 191, 199, 0.15)'" type="reset" variant="outline-secondary" v-if="!showInspectApprove">
                                <feather-icon icon="DeleteIcon" />
                                {{t('Close')}}
                            </b-button>
                    ...
                    <b-tab>
                        <template #title>
                            <feather-icon icon="XSquareIcon" size="16" class="mr-0 mr-sm-50" />
                            <span class="d-none d-sm-inline">{{t('Reject Loan List')}}</span>
                        </template>
                        <div>
                            <b-media class="mb-2">
                                <template #aside>
                            ...
                            <Transition name="bounce">
                                <b-row  v-if="!view_detail_reject_loan && !showInspectApprove">
                                    <b-col md="12">
                                        <hr/>
                                            <vue-good-table ref="my-table-calculate-table" :columns="columnsRejectLoan" :rows="rejectLoan" :rtl="direction" :line-numbers="true"
                                            :search-options="{
                                                enabled: false,                                        
                                            }" :select-options="{
                                                enabled: false,
                                                ...
                                                <template slot="table-row" slot-scope="props">
                                                    ...
                                                    <span v-if="props.column.field === 'reject_by2'">  
                    ...
                    <b-tab>
                        <template #title>
                            <feather-icon icon="CheckSquareIcon" size="16" class="mr-0 mr-sm-50" />
                            <span class="d-none d-sm-inline">{{t('Approved Loan List')}}</span>
                        </template>
                        <div>
                            <b-media class="mb-2">
                                <template #aside>
                            ...
                            <Transition name="bounce">
                                <b-row  v-if="!view_detail_approve_loan && !showInspectApprove">
                                    <b-col md="12">
                                        <hr/>
                                            <vue-good-table ref="my-table-calculate-table" :columns="columnsApproveLoan" :rows="approveLoan" :rtl="direction" :line-numbers="true" 
                                            :search-options="{
                                                enabled: false,                                        
                                            }" :select-options="{
                                                enabled: false,
                                                ...
                                                <template slot="table-row" slot-scope="props" >
                                                    ...
                                                    <span v-if="props.column.field === 'remain_loan2'">       
                                                        <b-badge v-if="props.row.remain_loan<=0" 
                                                            pill
                                                            variant="secondary"
                                                        >
                                                            {{(props.row.remain_loan).toLocaleString(undefined, { maximumFractionDigits: 2, minimumFractionDigits: 2 })}}
                                                        </b-badge>
                                                        <b-badge v-if="props.row.remain_loan>0" 
                                                            pill
                                                            variant="info"
                                                    ...
                                                    <span v-if="props.column.field === 'approve_by2'">  
                                                        <b-badge style="cursor: pointer; margin-right:2px" variant="success">                                                        
                                                    ...
                                                    <span v-if="props.column.field === 'action'">                                                    
                                                        <b-badge style="cursor: pointer; margin-right:2px" variant="info" @click="inspectApprovedData(props.row)">
                                                            <feather-icon icon="SearchIcon" size="16" class="mr-0 mr-sm-50" />
                                                            <span class="d-none d-sm-inline">{{t('Inspect')}}</span>
                                                        </b-badge>
                                                    </span>
