<template>
    ...
    <b-sidebar 
      ...
      right
      @hidden="resetForm"
      @change="(val) => $emit('update:is-view-data-sidebar-active', val)"
    >
  ...
  export default {
    ...
    model: {
      ...
      event: 'update:is-view-data-sidebar-active',
    },    
    props: {
    ...
    setup(props, { emit }) {
      ...
      const onSubmit = () => {
        store.dispatch('app-user/addUser', tmpData)
          .then(() => {
            emit('refetch-data')
            emit('update:is-view-data-sidebar-active', false)
          })
      }
