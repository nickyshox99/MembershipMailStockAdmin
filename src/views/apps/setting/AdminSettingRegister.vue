  ...
  <b-card>
    ...
    <b-form>
      <b-row>
        ...
        <b-col md="12">
          <b-form-checkbox
            id="accountSwitchRegisterSameNameEnable"
            :checked="localOptions.enable_name_dont_duplicate"
            v-model="localOptions.enable_name_dont_duplicate"
            name="check-button"
            switch
            inline
          >
            <span>Don't Register same name</span>
          </b-form-checkbox>
        </b-col>
