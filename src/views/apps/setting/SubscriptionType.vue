<template>
  ...
  <div>
    ...
    <subscription-type-edit :isEditFormActive="isEditFormActive" :pRowData="selectedDataRow" 
    ...
    <Transition name="fade" mode="out-in">
      <b-card :title="t('Subscription Type')" v-if="!(isEditFormActive)">
        <!-- table -->
...
import SubscriptionTypeEdit from './SubscriptionTypeEdit.vue';
...
export default {
  ...
  methods: {
    ...
    async deleteType(listId) {
      ...
      let response;
      await axios.post("api/subscriptiontype/deleteById/", body,
        {
          headers: {
