<template>
  ...
  <div>
    ...
    <announcement-setting-edit :isEditFormActive="isEditFormActive" :pRowData="selectedDataRow" 
...
import AnnouncementSettingEdit from './AnnouncementSettingEdit.vue';
import ToastificationContent from '@core/components/toastification/ToastificationContent.vue'

export default {
  components: {
    AnnouncementSettingEdit,
    BRow,
    BCol,
    VueGoodTable,
    BAvatar,
    ...
    return {
      ...
      columns: [
        ...
        },         
        {
          ...
          field: 'date_announcement',   
          formatFn: this.formatDateAssigned,
        },   
        {
          label: 'Update Date',
          field: 'update_date',    
  ...
  methods: {
    ...
    async search() {
      ...
      const response = await this.GetAnnouncement(formData);
        ...
        await this.$bvModal.msgBoxConfirm(this.$t('Please confirm that you want to delete'), {
          ...
          .then(value => {
            ...
            if (value) {
              ...
              this.deleteAnnouncement(selectID);
    ...
    async deleteAnnouncement(listId) {
      ...
      let response;
      await axios.post("api/announcement/deleteAnnouncementbyid/", body,
        {
          headers: {
