  ...
  <b-card>
    ...
    <b-form>
      <b-row>
        ...
        <b-col md="12">
          <b-form-group
            label-for="refundwithdrawminimun"
            label="Minimun Withdraw"
          >
            <b-form-input
              id="refundwithdrawminimun"
              v-model="localOptions.Minimum"
              placeholder="1"
            />
          </b-form-group>
        </b-col>
        ...
        <b-col md="12">
          <b-form-checkbox
            id="accountSwitchOtpRegisterEnable"
