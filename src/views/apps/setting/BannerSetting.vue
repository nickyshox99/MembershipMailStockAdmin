<template>
  ...
  <div>
    ...
    <banner-setting-edit :isEditFormActive="isEditFormActive" :pRowData="selectedDataRow" 
      ...
      <b-card title="จัดการป๊อปอัพ" v-if="!(isEditFormActive)">
        ...
        <vue-good-table ref="my-table" :columns="columns" :rows="rows" :rtl="direction" :line-numbers="true"
          ...
          <template slot="table-row" slot-scope="props">
            ...
            <span v-if="props.column.field === 'img2'">
              <img v-bind:src="props.row.img" alt="avatar" style="margin-right:10px;width: 50%;" />
            </span>
...
import BannerSettingEdit from './BannerSettingEdit.vue';
...
export default {
  ...
  methods: {
    ...
    async search() {
      ...
      const response = await this.GetBanner(formData);
    ...
    async deleteBanner(listId) {
      ...
      let response;
      await axios.post("api/banner/deleteBannerbyid/", body,
        {
          headers: {
