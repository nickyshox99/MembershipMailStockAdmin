...
<b-tabs vertical content-class="col-12 col-md-9 mt-1 mt-md-0" pills nav-wrapper-class="col-md-3 col-12" nav-class="nav-left">
    ...
    <b-tab active>
        <template #title>
            ...
            <span class="font-weight-bold">Daily Setting</span>
        </template>

        <daily-setting-edit v-if="settingdata.dailydepositreward" :setting-data="settingdata.dailydepositreward" />
    </b-tab>
...
import DailySettingEdit from './DailySettingEdit.vue'
