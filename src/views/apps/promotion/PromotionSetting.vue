<template>
  ...
  <div>
    ...
    <promotion-setting-edit :isEditFormActive="isEditFormActive" :pRowData="selectedDataRow" 
    ...
    <Transition name="fade" mode="out-in">
      <b-card :title="t('Promotion Manage')" v-if="!(isEditFormActive)">
        <!-- table -->
...
import PromotionSettingEdit from './PromotionSettingEdit.vue';
...
export default {
  ...
  methods: {
    ...
    async deletePromotion(listId) {
      ...
      let response;
      await axios.post("api/promotion/deletepromotionbyid/", body,
        {
          headers: {
