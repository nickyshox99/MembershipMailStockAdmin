<template>  
    ...
    <b-modal
            id="modal-forward-payment"
            ref="modalForwardPayment"
            v-model="showModalPrivate"
            :title="t('Forward To Next Due')"            
            @hidden="resetModal"
            @ok="handleOk"      
            size="sm"  
        ...
        >
            <form ref="form" @submit.stop.prevent="handleOk">
                ...
                <b-row>
                    <b-col md="12">                                
                        <b-form-group :label="t('Principle Amount')" label-for="principle_amount">
                            <b-input-group class="input-group-merge">
                                <b-input-group-prepend is-text >
                                    <feather-icon icon="CreditCardIcon" />
                                </b-input-group-prepend>
                                <b-form-input id="principle_amount" v-model="paymentInfo.principle_amount" type="number"
                                readonly />
                            </b-input-group>
                        </b-form-group>
                    </b-col>
                ...
                <b-row>
                    <b-col md="12">                                
                        <b-form-group :label="t('Interest Amount')" label-for="interest_amount">
                            <b-input-group class="input-group-merge">
                                <b-input-group-prepend is-text >
                                    <feather-icon icon="CreditCardIcon" />
                                </b-input-group-prepend>
                                <b-form-input id="interest_amount" v-model="paymentInfo.interest_amount" type="number"
                                readonly />
                            </b-input-group>
                        </b-form-group>
                    </b-col>
                ...
                <b-row>
                    <b-col md="12">                                
                        <b-form-group :label="t('Fine Amount')" label-for="fine_amount">
                            <b-input-group class="input-group-merge">
                                <b-input-group-prepend is-text >
                                    <feather-icon icon="CreditCardIcon" />
                                </b-input-group-prepend>
                                <b-form-input id="fine_amount" v-model="paymentInfo.fine_amount" type="number"
                                readonly />
                            </b-input-group>
                        </b-form-group>
                    </b-col>
...
export default {
  ...
  methods: {        
    ...
    ...mapActions(["UpdateForwardPaymentByPaymentId"]),
    ...
    async handleOk()
    {
        ...
        const response = await this.UpdateForwardPaymentByPaymentId(formData);
