    ...
    <b-modal
        ...
        >
            <form ref="form" @submit.stop.prevent="handleOk">
                <b-row v-if="paymentInfo.unpaid_previous_principle_amount>0">
                    <b-col md="12">                                
                        <b-form-group :label="t('Previous Principle Amount')" label-for="previous_principle_amount">
                            <b-input-group class="input-group-merge" style="color:red;">                       
                                {{ (paymentInfo.unpaid_previous_principle_amount) }}
                            </b-input-group>
                        </b-form-group>
                    </b-col>
                </b-row>
                <b-row v-if="paymentInfo.unpaid_previous_interest_amount>0">
                    <b-col md="12">                                
                        <b-form-group :label="t('Previous Interest Amount')" label-for="previous_interest_amount">
                            <b-input-group class="input-group-merge" style="color:red;">                        
                                {{ (paymentInfo.unpaid_previous_interest_amount) }}
                            </b-input-group>
                        </b-form-group>
                    </b-col>
                </b-row>
                <b-row v-if="paymentInfo.unpaid_previous_fine_amount>0">
                    <b-col md="12">                                
                        <b-form-group :label="t('Previous Fine Amount')" label-for="previous_fine_amount">
                            <b-input-group class="input-group-merge" style="color:red;">                              
                                {{ (paymentInfo.unpaid_previous_fine_amount) }}
                            </b-input-group>
                        </b-form-group>
                    </b-col>
                </b-row>
                ...
                <b-row>
                    <b-col md="12">                                
                        <b-form-group :label="t('Current Principle Amount')" label-for="principle_amount">
                            <b-input-group class="input-group-merge">                                
                                {{ (paymentInfo.principle_amount) }}
                            </b-input-group>
                        </b-form-group>
                    </b-col>
                </b-row>        
                ...
                <b-row>
                    <b-col md="12">                                
                        <b-form-group :label="t('Current Interest Amount')" label-for="interest_amount">
                            <b-input-group class="input-group-merge">                                
                                {{ (paymentInfo.interest_amount) }}
                            </b-input-group>
                        </b-form-group>
                    </b-col>
                </b-row>
                ...
                <b-row>
                    <b-col md="12">                                
                        <b-form-group :label="t('Current Fine Amount')" label-for="fine_amount">
                            <b-input-group class="input-group-merge">                                                                
                                {{ (paymentInfo.fine_amount) }}
                            </b-input-group>
                        </b-form-group>
                    </b-col>
                </b-row>
                ...
                <b-row>
                    <b-col md="12">                                
                        <b-form-group :label="t('Current Total Amount')" label-for="total_amount">
                            <b-input-group class="input-group-merge">
                                <b-input-group-prepend is-text >
                                    <feather-icon icon="CreditCardIcon" />
                                </b-input-group-prepend>
                                <b-form-input id="total_amount" v-model="paymentInfo.total_amount" type="number"
                                readonly />
                            </b-input-group>
                        </b-form-group>
                    </b-col>
...
export default {
  ...
  methods: {        
    ...
    resetModal()
    {
        ...
        this.$emit('close-totalpayment-info');
    },
    async handleOk()
    {
        this.$emit('close-totalpayment-info');
