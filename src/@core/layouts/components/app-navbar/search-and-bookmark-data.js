...
export default {
  pages: {
    ...
    data: [
      ...
      { title: 'Dashboard', route: { name: 'dashboard' }, icon: 'ShoppingCartIcon', isBookmarked: false },
      ...
      { title: 'Manage Member', route: { name: 'apps-members-list' }, icon: 'UserIcon', isBookmarked: false },
      { title: 'Report Member', route: { name: 'apps-members-list' }, icon: 'UserIcon', isBookmarked: false },
      { title: 'Report Transaction', route: { name: 'apps-report-deposit' }, icon: 'UserIcon', isBookmarked: false },
      { title: 'Manage Bank', route: { name: 'apps-bank-admin' }, icon: 'UserIcon', isBookmarked: false },
      { title: 'Report Deposit Only', route: { name: 'apps-report-deposit' }, icon: 'UserIcon', isBookmarked: false },
    ],
  },
  files: {
    key: 'file_name',
